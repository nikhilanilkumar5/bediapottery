    ...
    <div className={`space-y-4 ${className}`}>
      <div>
        ...
        <Content className=" leading-relaxed">
          Choose the number of participants and add the workshop to your cart to
