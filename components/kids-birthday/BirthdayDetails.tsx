 ...
 const timelineSteps = [
  {
    ...
    time: "15 Mins",
    desc: "Settle In And Get Ready For The Fun",
  },
  {
    num: "02",
    title: "Pottery Workshop",
    time: "60 Mins",
    desc: "Hands-On Pottery Making With Instructors",
  },
  {
    num: "03",
    title: "Cake Cutting",
    time: "30 Mins",
    desc: "Celebration Time With Cake And Snacks",
  },
  {
    num: "04",
    title: "Wrapping Up The Party",
    time: "15 Mins",
    desc: "Final Photos & Happy Goodbyes",
  },
  {
    num: "05",
...
const kidsBirthdayTimelineSteps = [
  {
    num: "01",
    title: "Arrival & Welcome",
    time: "15 Mins",
  ...
  },
  {
    ...
    title: "Wrapping Up",
    time: "15 Mins",
    desc: "Each Child Leaves With Their Creation",
  },
];
 ...
 <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-8 lg:p-10 text-center shadow-sm flex flex-col items-center">
              ...
              <p className="text-[14px] text-black">Maximum Number Of Participants: 16</p>
            </div>
